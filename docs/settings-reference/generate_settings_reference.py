...
GUI_CONTROLS: list[dict[str, str]] = [
    ...
    row("Mouse", "Direct Targeting Movement", "Target signal diagnostics", "target_signal_diagnostics_enabled", "Activate/deactivate", "true/false", "Shows passive tuning diagnostics for stream cadence, error, output counts, frequency content, lag, and stability.", "overlay/draw_mouse.cpp"),
