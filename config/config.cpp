...
bool Config::loadConfig(const std::string& filename)
{
    ...
    if (!std::filesystem::exists(target))
    {
        ...
        kalman_process_noise_velocity = kKalmanProcessNoiseVelocityDefault;
        kalman_measurement_noise = kKalmanMeasurementNoiseDefault;
        kalman_velocity_damping = kKalmanVelocityDampingDefault;
    ...
    runtime_latency_sweep_enabled = get_bool("runtime_latency_sweep_enabled", kRuntimeLatencySweepEnabledDefault);
    ...
    kalman_process_noise_velocity = (float)get_double("kalman_process_noise_velocity", kKalmanProcessNoiseVelocityDefault);
    kalman_measurement_noise = (float)get_double("kalman_measurement_noise", kKalmanMeasurementNoiseDefault);
    kalman_velocity_damping = (float)get_double("kalman_velocity_damping", kKalmanVelocityDampingDefault);
    ...
    kalman_acquisition_frames = get_long("kalman_acquisition_frames", kKalmanAcquisitionFramesDefault);
